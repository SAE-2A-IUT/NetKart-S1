...
<script>
    ...
    var language = {
        ...
        en: {
            ...
            interface_text: "The game is presented in the form of four main blocks<br><ol><li>This part consists of the circuit name, image (between 0 and 3), instruction and current question. This block is updated with each change of question and contains all the information necessary for the success of a circuit.</li><li>This block contains the terminal in which the player must enter answers to the questions in the same way as it is possible to type commands in a real terminal. When an answer is entered, it is checked and a text is displayed in return to indicate whether the answer is correct.</li><li>The player can receive help when completing certain questions. There may be between 0 and three clues which, when clicked, can redirect to an external help page for NetKart.</li><li>The circuit allows us to follow the remaining time by observing the progress of the enemy, but also to follow the progress of the user. A flag can be observed, which represents the starting point but also the finish line.</li></ol>",
            interface_title2: "Use images for help",
            interface_text2: "On some circuits, you will have the possibility to complete your questions with the help of images provided. To better observe them, you can hover over an image to display it larger in the middle of the screen.",
            interface_title3: "Follow the path to victory!",
            interface_text3: "Here is an example of a question, each circuit consists of 3 questions.<br>When you press 'enter' after entering an answer in the terminal, your answer is checked and the previous answers entered appear above the latest. After several attempts, you will still have the possibility to see your previous answers thanks to a vertical scroll bar.<br>After entering a correct answer, the next question will be displayed with its instruction, images, and links if there are any. In addition, the user's character will make two moves out of the six that he has to make in total in order to reach the finish line.",
            interface_title4: "Increase your score by coming first!",
            interface_text4: "When the player reaches the finish line, he wins the game and his score increases.<br>It is possible to return to the theme selection by pressing the back button. The restart button allows you to restart the current circuit.<br>You only earn points on the first victory on each circuit.",
