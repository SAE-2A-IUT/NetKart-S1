...
?>
    <div style="margin: 5%">
        ...
        <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de l’utilisation du site netkart.alwaysdata.net et de ses services.
            <br/>
        ...
        <p>
            Le site netkart.alwaysdata.net est édité par des étudiants de l’IUT Informatique, domiciliés à Aix-en-Provence.
        </p>
        <h3>ARTICLE 3 : accès aux services</h3>
        <p>
            L’Utilisateur du site netkart.alwaysdata.net a accès aux services suivants :
        </p>
            <ul>
                <li>Inscription</li>
                <li>Contact</li>
        ...
        <p>
            ...
            <ul>
                <li>Jeu solo</li>
                <li>Création de session multijoueur</li>
                <li>Administration de session</li>
                <li>Gestion de circuits</li>
            </ul>
            <p>
        ...
        <p>
            ...
            <br/>
            L’Utilisateur assume l’entière responsabilité de l’utilisation qu’il fait des informations et contenus présents sur le site netkart.alwaysdata.net.
            <br/>
        ...
        <p>
            ...
            <br/>
            Le site netkart.alwaysdata.net s'engage à mettre en œuvre tous les moyens nécessaires pour garantir la sécurité et la confidentialité des données. Toutefois, il n’apporte pas une garantie de sécurité totale.
            <br/>
        ...
        <p>
            Les contenus du site netkart.alwaysdata.net (logos, textes, éléments graphiques, vidéos, etc.) sont protégés par le droit d’auteur, en vertu du Code de la propriété intellectuelle.
            <br/>
        ...
        <p>
            ...
            <br/>
            L’adresse électronique (e-mail) de l’utilisateur pourra notamment être utilisée par le site netkart.alwaysdata.net pour la communication d’informations diverses et la gestion du compte.
            <br/>
            netkart.alwaysdata.net garantit le respect de la vie privée de l’utilisateur, conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.
            <br/>
        ...
        <p>
            Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la responsabilité de l’Éditeur de netkart.alwaysdata.net, qui n’a pas de contrôle sur ces liens.
            <br/>
            Il est possible pour un tiers de créer un lien vers une page du site netkart.alwaysdata.net sans autorisation expresse de l’éditeur.

        </p>
        <h3>ARTICLE 9 : Évolution des conditions générales d’utilisation</h3>
        <p>
            Le site netkart.alwaysdata.net  se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.
        </p>
